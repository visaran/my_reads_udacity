This is the first project of the Udacity Nanodegree React Course.
The name of the project is "My reads" and it was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
